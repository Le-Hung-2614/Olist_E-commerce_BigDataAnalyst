...
CATEGORY_VI = {
    "health_beauty": "Sức khoẻ & Làm đẹp",
    "watches_gifts": "Đồng hồ & Quà tặng",
    "bed_bath_table": "Giường, Phòng tắm & Bàn",
    "sports_leisure": "Thể thao & Giải trí",
    "computers_accessories": "Máy tính & Phụ kiện",
    "furniture_decor": "Nội thất & Trang trí",
    "housewares": "Đồ gia dụng",
    "cool_stuff": "Đồ hay",
    "garden_tools": "Dụng cụ vườn",
    "auto": "Ô tô & Phụ tùng",
    "toys": "Đồ chơi",
    "baby": "Đồ trẻ em",
    "perfumery": "Nước hoa",
    ...
    "electronics": "Điện tử",
    "fashion_bags_accessories": "Túi & Phụ kiện thời trang",
    "fashion_shoes": "Giày đẹp",
